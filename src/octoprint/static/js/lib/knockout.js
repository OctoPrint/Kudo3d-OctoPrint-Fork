    ...
    function L(w) {
        ...
        function ca(a, d) {
            if (a)
                ...
                for (var c = 0, e = a.childNodes, f = e.length; c < f; c++) ca(e[c],
                    d)
        }
        ...
        b.a = new function() {
            ...
            for (var f in c) {
                var g = c[f];
                if (g.length)
                    for (var h = 0, k = g.length; h < k; h++) e[g[h]] = f
            }
            var l = {
                    propertychange: m
                },
            ...
            return {
                ...
                P: function(a, b) {
                    if (b instanceof Array) a.push.apply(a,
                        ...
                        for (var d = 0, c = b.length; d < c; d++) a.push(b[d]);
                    return a
                },
                extend: function(a, b) {
                    if (b)
                ...
                N: function(a, d) {
                    b.a.ka(a);
                    if (d)
                        for (var c = 0, e = d.length; c < e; c++) a.appendChild(d[c])
                },
                Ya: function(a, d) {
                ...
                Jb: function(a, d, c) {
                    ...
                    if ("object" == typeof a && "form" === b.a.u(a))
                        for (var g = a.action, h = f.length - 1; 0 <= h; h--)
                            for (var k = b.a.Oa(a, f[h]), l = k.length - 1; 0 <= l; l--) e[k[l].name] = k[l].value;
                    d = b.a.d(d);
        ...
        b.a.ca = function(a, d) {
            ...
            if (d !== p && d !== I)
                if ("string" != typeof d && (d = d.toString()),
                    ...
                    for (var c = b.a.ta(d), e = 0; e < c.length; e++) a.appendChild(c[e])
        };
        ...
        b.a.$a = function(a, d, c, e, f) {
            ...
            function h(a, c) {
                if (a)
                    for (var d = 0, e = c.length; d < e; d++) c[d] && b.a.o(c[d].M,
                        function(b) {
                            a(b, d, c[d].U)
                        })
            }
